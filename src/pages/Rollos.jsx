...
export default function Rollos() {
  ...
  return (
    <>
      <SEOHead
        title={t("Rollos Térmicos 80x80 para POS y ATM | Autocopiante — Key Solutions S.A.C Perú Bolivia")}
        description={t("Rollos de papel térmico 80x80mm y autocopiante para impresoras POS y cajeros automáticos ATM. Alta calidad de impresión, metraje certificado y libre de BPA. Proveedor en Perú y Bolivia.")}
        keywords={t("rollos termicos 80x80, papel termico POS, rollos termicos ATM, rollo autocopiante, papel termico cajero automatico, rollo termico impresora punto venta, insumos POS termico Peru Bolivia, rollo termico banco")}
        path="/rollos-termicos"
      />

      <ProductDetailHero
        label={t("Insumos para POS y ATM")}
        title={t("Rollos Térmicos")}
        subtitle={t("80×80 · Autocopiante · Tamaños personalizados para cajeros automáticos y terminales de pago")}
      />
      ...
      <section className="py-20 bg-brand-light">
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          <SectionTitle
            ...
            title={t("Rollos para cada terminal")}
          />
      ...
      <section className="py-20 bg-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6">
          <SectionTitle
            label={t("Especificaciones")}
            title={t("Calidad garantizada en cada rollo")}
          />
