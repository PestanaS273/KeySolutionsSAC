...
export default function SobresPreimpresos() {
  ...
  return (
    <>
      <SEOHead
        title={t("Sobres PIN Mailer, Con Ventana y Formas Continuas Bancarias | Key Solutions S.A.C")}
        description={t("Sobres de seguridad PIN Mailer para entrega de claves de tarjetas bancarias, sobres con ventana y formularios continuos preimpresos para el sector financiero. Fabricación a medida en Perú y Bolivia.")}
        keywords={t("sobre PIN mailer banco, PIN mailer seguridad tarjetas, sobre con ventana preimpreso, formas continuas bancarias, formularios continuos preimpresos, sobre seguridad bancario, sobre entrega tarjeta credito, formularios bancarios Peru Bolivia")}
        path="/sobres-preimpresos"
      />

      <ProductDetailHero
        label={t("Formularios y sobres")}
        title={t("Sobres y Formularios Preimpresos")}
        subtitle={t("Formas continuas · PIN Mailer · Sobres con ventana — Para el sector financiero y empresarial")}
      />
      ...
      <section className="py-20 bg-brand-light">
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          <SectionTitle
            label={t("Catálogo")}
            title={t("Formatos para cada necesidad")}
          />
      ...
      <section className="py-20 bg-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6">
          <SectionTitle
            ...
            title={t("Formularios hechos a su medida")}
          />
            ...
            {features.map((f, i) => (
              <AnimatedSection key={f} delay={i * 0.07}>
                <div className="flex items-start gap-3 p-4 bg-brand-light rounded-xl">
                  ...
                  <p className="text-gray-700">{t(f)}</p>
                </div>
              </AnimatedSection>
            ))}
          </div>
