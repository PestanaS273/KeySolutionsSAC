...
export default function TarjetasEmpresa() {
  ...
  return (
    <>
      <SEOHead
        title={t("Tarjetas PVC Empresa, Hotel y Control de Acceso | Key Solutions S.A.C")}
        description={t("Tarjetas PVC para hoteles, casinos, corporaciones y sistemas de control de acceso. Chip, banda magnética y código de barras. Impresión personalizada. Perú y Bolivia.")}
        keywords={t("tarjetas PVC empresa, tarjetas hotel llave, tarjetas control acceso, tarjetas identificacion corporativa, tarjeta magnetica hotel, tarjetas PVC personalizadas, carnet corporativo, tarjeta casino, tarjeta acceso Peru Bolivia")}
        path="/tarjetas-empresa"
      />

      <ProductDetailHero
        label={t("Tarjetas corporativas")}
        title={t("Tarjetas Empresa")}
        subtitle={t("Identificación · Control de acceso · Llaves de hotel — Soluciones PVC para el sector empresarial")}
      />

      <section className="py-20 bg-brand-light">
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          <SectionTitle
            label={t("Tipos disponibles")}
            title={t("Tarjetas para cada necesidad empresarial")}
          />
